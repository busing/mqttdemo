package com.taiyuan.mtqqdemo.client;
...
import com.taiyuan.mtqqdemo.server.MqttConfig;
/**
 * 
 ...
 * @author longgangbai
 */
public class MtqqClient {
	    private static final Logger LOG = Logger.getLogger(MtqqClient.class);
		private final static String CONNECTION_STRING = "tcp://121.40.55.170:1883";
		...
		public  static Topic[] topics = {
			    		...
			    		new Topic(MqttConfig.TOPIC_DOCTOR, QoS.AT_LEAST_ONCE),
